...
/**
 * ASU CAIE · UMS Portal  —  JavaFX
 *
 * Compile:
 *   FX=/usr/share/java
 *   javac -cp "$FX/javafx-base.jar:$FX/javafx-graphics.jar:$FX/javafx-controls.jar" UMSPortal.java
 *
 * Run:
 ...
 *        -cp . UMSPortal
 *
 *   -- or with classpath-style jars (JavaFX 11 system install):
 *   java -cp ".:$FX/javafx-base.jar:$FX/javafx-graphics.jar:$FX/javafx-controls.jar" UMSPortal
 */
