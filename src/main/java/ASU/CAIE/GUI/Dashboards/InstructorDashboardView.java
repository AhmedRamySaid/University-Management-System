...
public class InstructorDashboardView {
        ...
        public Node build() {
                ...
                VBox pendingCard = buildStatCard("Pending Grading", String.valueOf(pending), "#d97706", "#fffbeb",
                                "#fde68a", "⏳");
                VBox courseCard = buildStatCard("Active Courses", String.valueOf(courses.size()), "#2563eb", "#eff6ff",
                                "#bfdbfe", "📖");
