...
import ASU.CAIE.service.GradeViewService;
...
public class StudentDashboardView {
    ...
    private final GradeViewService gradeService = new GradeViewService();
    ...
    public Node build() {
        ...
        double      gpa     = dashService.calculateGPA(user.getId());
        List<Course> courses = dashService.getStudentCourses(user.getId());
        List<Grade>  grades  = gradeService.getStudentGrades(user.getId());
