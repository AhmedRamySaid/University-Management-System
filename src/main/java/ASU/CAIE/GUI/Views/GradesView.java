...
public class GradesView {
    ...
    private final GradeViewService service = new GradeViewService();
    ...
    public Node build() {
        ...
        List<Grade> grades = service.getStudentGrades(user.getId());
        double gpa = service.calculateGPA(grades);
